...
app.include_router(user_controller.router, prefix="/vocan-agent/user", tags=["User"])
...
app.include_router(language_controller.router, prefix="/vocan-agent/languages", tags=["Language"])